...
import pytest
from source_the_graph.source import TheGraphStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TheGraphStream, "path", "v0/example_endpoint")
    mocker.patch.object(TheGraphStream, "primary_key", "test_primary_key")
    mocker.patch.object(TheGraphStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = TheGraphStream()
